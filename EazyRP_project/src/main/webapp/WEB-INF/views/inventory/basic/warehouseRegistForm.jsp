			...
			<div class="col-md-9" style="max-width: 600px;">
				<div class="card card-outline card-info">
					<div class="card-header">
						<h3 class="card-title p-1">창고 등록</h3>
					...
					<div class="card-body pad">
						<form role="form" method="post" action="registWarehouse.do" name="detailForm">
							...
							<div class="form-group col-sm-12 row">
								...
								<input type="text" id="wh_name" name="wh_name" class="form-control col-sm-9 mch1" value="" style="background-color: white;">
							</div>
							<div class="form-group col-sm-12 row">
